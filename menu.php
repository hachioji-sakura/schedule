...
-->
			...
			<li><b>請求明細書送付準備（明細書をスプレッドシートおよびpdfファイルに出力）</b><br>
				<form name="form3" method="get" action="check_statement_timestamp.php">
				<input type="text" name="y" value="<?php echo $year; ?>" size="4">年&nbsp;
				<input type="text" name="m" value="<?php echo $month; ?>" size="4">月分&nbsp;
				<input type="hidden" name="nextlink" value="">
				<input type="submit" value="勤務実績確認" onclick="document.form3.action='check_SON_cal_fix.php'">
				<input type="submit" value="PDF出力" onclick="document.form3.nextlink.value='all_output_pdf.php'">
				<input type="submit" value="請求メールスプレッドシート出力" onclick="document.form3.nextlink.value='check_SON_cal_fix_go.php'"><br>
				</form>
			<li><b>部門別受講料</b><br>
...
<!--
       <h4>■ 季節講習・土日講習スケジュール取り込み</h4>
        <form method="post" action="upload_season_calender.php?go=1">
